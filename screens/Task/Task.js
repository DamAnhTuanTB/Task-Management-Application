...
export default ({ navigation, name, description, isImportant, color, date, id, status, tasks, setTasks }) => {
      ...
      <View style={[{
        ...
        <View style={[{
          ...
          <Image
            ...
            source={importantTask ? require('../../assets/important.jpg') : require('../../assets/noImportant.jpg')}
          />
          <Image
